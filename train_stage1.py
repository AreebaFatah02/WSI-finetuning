...
parser.add_argument('--results_dir', default='/kaggle/working/WSI-finetuning/results', help='results directory (default: ./results)')
...
args.split_dir = "splits/task_camelyon16/"
